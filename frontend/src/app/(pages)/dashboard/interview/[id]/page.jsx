...
const page = () => {
  ...
  return (
    <div className="px-4 md:px-32 py-10 flex flex-col md:flex-row gap-10">
    ...
    <div className='rounded-lg w-full md:w-1/2 h-auto p-4'> 
      ...
      <div className='flex justify-center items-center mt-5 py-2'>
        <button className='px-4 py-2 bg-indigo-700 text-white rounded hover:bg-blue-700 transition duration-200 ease-in-out' onClick={start}>Start Interview</button>
      </div>
    </div>
