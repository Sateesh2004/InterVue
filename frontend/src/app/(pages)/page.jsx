...
<div className="relative overflow-hidden before:absolute before:top-0 before:start-1/2 before:bg-[url('https://preline.co/assets/svg/examples/squared-bg-element.svg')]  before:bg-no-repeat before:bg-top before:size-full before:-z-[1] before:transform before:-translate-x-1/2">
  <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
    ...
    <div className="hidden sm:flex justify-center">
      <Link className={`inline-flex items-center gap-x-2 bg-white border border-gray-200 text-xs text-gray-600 p-2 px-3 rounded-full transition hover:border-gray-300 focus:outline-none focus:border-gray-300 ${inter.className}` } href="#">
        Enhance Your <span className='text-indigo-700'>Interview</span> Experience
        <span className="flex items-center gap-x-1">
          <span className="border-s border-gray-200 text-indigo-700 ps-2 ">Explore</span>
          <svg className="shrink-0 size-4 text-indigo-700" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6"/></svg>
        </span>
      </Link>
    </div>
    ...
    <div className="mt-5 max-w-xl text-center mx-auto">
      ...
      Ace Your <span className='text-indigo-700'>Interview</span> with AI
      </h1>
    </div>
    ...
    <div className="mt-8 gap-3 flex justify-center">
      <Link className={`inline-flex justify-center items-center  text-center bg-indigo-700 hover:bg-blue-700 focus:outline-none focus:from-violet-600 focus:to-blue-600 border border-transparent text-white text-sm font-medium text-[16px] rounded-full py-3 px-4 ${inter.className}`} href="/dashboard">
      ...
      <div className="max-w-6xl mx-auto py-16 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-md:max-w-md mx-auto">
          <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
            <div className="p-8">
              <svg xmlns="http://www.w3.org/2000/svg" fill="#303F9F" className="w-8 mb-6" viewBox="0 0 32 32">
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
            <div className="p-8">
              <svg xmlns="http://www.w3.org/2000/svg" fill="#303F9F" className="w-8 mb-6" viewBox="0 0 682.667 682.667">
                <defs>
                  <clipPath id="a" clipPathUnits="userSpaceOnUse">
                    <path d="M0 512h512V0H0Z" data-original="#000000" />
                  </clipPath>
                </defs>
                <g fill="none" stroke="#303F9F" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="40" clipPath="url(#a)" transform="matrix(1.33 0 0 -1.33 0 682.667)">
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
            <div className="p-8">
              <svg xmlns="http://www.w3.org/2000/svg" fill="#303F9F" className="w-8 mb-6" viewBox="0 0 24 24">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:flex lg:items-center">
          <ul className="flex space-x-6">
            <li>
                <svg xmlns="http://www.w3.org/2000/svg" className="fill-gray-900  w-7 h-7" viewBox="0 0 24 24">
            ...
            <li>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" className="fill-gray-900  w-7 h-7"
                  viewBox="0 0 24 24">
                  <path
